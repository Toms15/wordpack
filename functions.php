...
function wordpack_scripts() {
	...
	wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/css/app.css' );

	wp_enqueue_script( 'wordpack-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
    wp_enqueue_script( 'custom-script', get_template_directory_uri() . '/js/app.js', array(), '1.0.0', true);
